...
export const QuizSettings: React.FC<Props> = ({ questionCount, onStartQuiz }) => {
    ...
    return (
        <div className="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <button
                onClick={handleStart}
                className="w-full px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors dark:bg-blue-500 dark:hover:bg-blue-600 shadow-md"
            >
                Start Quiz
            </button>
        </div>
